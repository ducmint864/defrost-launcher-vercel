module.exports = class Data1729087378192 {
    name = 'Data1729087378192'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "timestamp" integer NOT NULL, "block" integer NOT NULL, "token_id" character varying, "from_id" character varying, "to_id" character varying, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
