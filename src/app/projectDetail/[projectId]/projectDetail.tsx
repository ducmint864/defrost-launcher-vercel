...
import { useChain, useAddress, useContract } from "@thirdweb-dev/react";
...
const ProjectDetailPage = () => {
  ...
  const [poolContract, setPoolContract] = useState<ethers.Contract | undefined>(
    undefined
  );
  ...
  const [userDepositedAmount, setUserDepositedAmount] = useState<bigint>(
    BigInt(0)
  );
  ...
  useEffect(() => {
    ...
    const fetchProjectDetails = async () => {
      ...
      const depositedAmount = await poolContract!.getUserDepositAmount(
        userAddress
      );
  ...
  return (
    <div className="flex justify-center items-center bg-primary min-h-screen ">
      ...
      <dialog id="investDialog" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box bg-primary text-primary-content backdrop-blur-lg shadow-sm">
          ...
          <div className="flex flex-col w-full mt-10 mb-5 p-4 gap-y-4">
            ...
            <p
              id="investAmountAlert"
              className="my-auto ml-4 text-red-600 font-bold"
            >
              &nbsp;
            </p>
